...
public class Register {
    ...
    Note: if makeUsernameDynamic==true, make the username dynamic and set the value of this.lastGeneratedUsername =<dynamic username>
    */
    public Boolean registerUser(String Username , String Password, Boolean makeUsernameDynamic ) throws InterruptedException
    {
        ...
        return this.driver.getCurrentUrl().endsWith("/login"); // Return true if registration succeds and re-directed to login page
    }
}
